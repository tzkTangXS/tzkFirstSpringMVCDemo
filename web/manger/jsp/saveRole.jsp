...
<div class="container">
    <div class="row">
        <div class="divForm col-md-7 topeidt">
            <form action="${pageContext.request.contextPath}/manger/saveRole.do">
                ...
                <div class="s"><select name="partId" id="" class="s">
                    <option value="${null}">
                        无
                    </option>
                ...
                <div class="form-group">
                    <button class="btn btn-warning input-lg col-md-12">添加员工</button>
                </div>
            </form>
        </div>
    </div>
